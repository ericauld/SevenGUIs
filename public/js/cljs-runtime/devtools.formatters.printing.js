...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31082){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31083,G__31084,seq31082__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31125_SHARP_){
return (!((cljs.core.meta(p1__31125_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31149__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31155){var _e__28605__auto__ = e31155;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e31157){var _e__28605__auto__ = e31157;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31159 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31160 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31160);

try{var map__31161 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31161__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31159);
}});
...
var temp__5733__auto___31183 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___31183)){
var managed_print_level_31184 = temp__5733__auto___31183;
var _STAR_print_level_STAR__orig_val__31167_31185 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31168_31186 = managed_print_level_31184;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31168_31186);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31166_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31166_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31167_31185);
}} else {
job_fn();
}
