...
var G__29691 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__29691)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__29691)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__29691)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29691)].join('')));
...
var G__29769 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__29770 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__29769;
v = G__29770;
continue;
} else {
var G__29772 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__29773 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__29772;
v = G__29773;
continue;
}
...
break;
case "\"":
var G__29774 = cljs.core.next(sq);
var G__29775 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__29774;
v = G__29775;
continue;
...
break;
default:
var G__29777 = cljs.core.next(sq);
var G__29778 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__29777;
v = G__29778;
continue;
...
while(true){
var G__29708 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__29708__$1 = (((G__29708 instanceof cljs.core.Keyword))?G__29708.fqn:null);
switch (G__29708__$1) {
case "rule":
var vec__29709 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29709,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29709,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__29712 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__29712) : instaparse.cfg.content.call(null,G__29712));
...
break;
case "paren":
var G__29795 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__29795;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__29713 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__29713) : instaparse.cfg.build_rule.call(null,G__29713));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__29714 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__29714) : instaparse.cfg.build_rule.call(null,G__29714));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__29715 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__29715) : instaparse.cfg.build_rule.call(null,G__29715));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__29716 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__29716) : instaparse.cfg.build_rule.call(null,G__29716));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__29717 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__29717) : instaparse.cfg.build_rule.call(null,G__29717));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__29718 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__29718) : instaparse.cfg.build_rule.call(null,G__29718));
})());
...
while(true){
var G__29719 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__29818 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__29818;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29719__$1)].join('')));
...
var valid_nts_29819 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__29720_29820 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__29721_29821 = null;
var count__29722_29822 = (0);
var i__29723_29823 = (0);
while(true){
if((i__29723_29823 < count__29722_29822)){
var nt_29829 = chunk__29721_29821.cljs$core$IIndexed$_nth$arity$2(null,i__29723_29823);
if(cljs.core.truth_((valid_nts_29819.cljs$core$IFn$_invoke$arity$1 ? valid_nts_29819.cljs$core$IFn$_invoke$arity$1(nt_29829) : valid_nts_29819.call(null,nt_29829)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_29829),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__29831 = seq__29720_29820;
var G__29832 = chunk__29721_29821;
var G__29833 = count__29722_29822;
var G__29834 = (i__29723_29823 + (1));
seq__29720_29820 = G__29831;
chunk__29721_29821 = G__29832;
count__29722_29822 = G__29833;
i__29723_29823 = G__29834;
continue;
} else {
var temp__5735__auto___29835 = cljs.core.seq(seq__29720_29820);
if(temp__5735__auto___29835){
var seq__29720_29836__$1 = temp__5735__auto___29835;
if(cljs.core.chunked_seq_QMARK_(seq__29720_29836__$1)){
var c__4556__auto___29837 = cljs.core.chunk_first(seq__29720_29836__$1);
var G__29838 = cljs.core.chunk_rest(seq__29720_29836__$1);
var G__29839 = c__4556__auto___29837;
var G__29840 = cljs.core.count(c__4556__auto___29837);
var G__29841 = (0);
seq__29720_29820 = G__29838;
chunk__29721_29821 = G__29839;
count__29722_29822 = G__29840;
i__29723_29823 = G__29841;
continue;
} else {
var nt_29842 = cljs.core.first(seq__29720_29836__$1);
if(cljs.core.truth_((valid_nts_29819.cljs$core$IFn$_invoke$arity$1 ? valid_nts_29819.cljs$core$IFn$_invoke$arity$1(nt_29842) : valid_nts_29819.call(null,nt_29842)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_29842),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__29844 = cljs.core.next(seq__29720_29836__$1);
var G__29845 = null;
var G__29846 = (0);
var G__29847 = (0);
seq__29720_29820 = G__29844;
chunk__29721_29821 = G__29845;
count__29722_29822 = G__29846;
i__29723_29823 = G__29847;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__29724_29849 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29725_29850 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29726_29851 = true;
var _STAR_print_fn_STAR__temp_val__29727_29852 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29726_29851);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29727_29852);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29725_29850);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29724_29849);
}
...
var G__29870 = (i__4737__auto___29865 + (1));
i__4737__auto___29865 = G__29870;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__29730){
...
var _STAR_case_insensitive_literals_STAR__orig_val__29733 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__29734 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__29734);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__29735_29880 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29736_29882 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29737_29883 = true;
var _STAR_print_fn_STAR__temp_val__29738_29884 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29737_29883);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29738_29884);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29736_29882);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29735_29880);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__29733);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq29728){
var G__29729 = cljs.core.first(seq29728);
var seq29728__$1 = cljs.core.next(seq29728);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29729,seq29728__$1);
}));
