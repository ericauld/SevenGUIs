...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_32446 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_32446(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_32447 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_32447(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_32448 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_32448(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_32452 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_32452(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_32453 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_32453(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_32466 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_32466(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_32471 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_32471(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_32472 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_32472(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_32474 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_32474(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_32475 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_32475(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32482 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32482(b);
}
});
