...
var G__28560 = evt.clientX;
var G__28561 = evt.clientY;
return (on_drag.cljs$core$IFn$_invoke$arity$2 ? on_drag.cljs$core$IFn$_invoke$arity$2(G__28560,G__28561) : on_drag.call(null,G__28560,G__28561));
});
});
...
var scroll_dist = (cljs.core.truth_(page)?view_height:(function (){var or__4126__auto__ = (function (){var and__4115__auto__ = cell;
...
var container = (reagent.core.dom_node.cljs$core$IFn$_invoke$arity$1 ? reagent.core.dom_node.cljs$core$IFn$_invoke$arity$1(scroller) : reagent.core.dom_node.call(null,scroller));
...
var lower_bound = (function (){var x__4217__auto__ = drag_col;
var y__4218__auto__ = drop_col;
return ((x__4217__auto__ < y__4218__auto__) ? x__4217__auto__ : y__4218__auto__);
})();
var upper_bound = (function (){var x__4214__auto__ = drag_col;
var y__4215__auto__ = drop_col;
...
var G__28563 = (view_col + (1));
return (cur.cljs$core$IFn$_invoke$arity$1 ? cur.cljs$core$IFn$_invoke$arity$1(G__28563) : cur.call(null,G__28563));
} else {
...
var G__28564 = (view_col - (1));
return (cur.cljs$core$IFn$_invoke$arity$1 ? cur.cljs$core$IFn$_invoke$arity$1(G__28564) : cur.call(null,G__28564));
} else {
return null;
}
}
...
var G__28606 = cljs.core.rest(sorting__$1);
var G__28607 = true;
var G__28608 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [model_col,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569))], null));
sorting__$1 = G__28606;
found = G__28607;
result = G__28608;
continue;
} else {
var G__28609 = cljs.core.rest(sorting__$1);
var G__28610 = found;
var G__28611 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,column);
sorting__$1 = G__28609;
found = G__28610;
result = G__28611;
continue;
}
...
return cljs.core.second(cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__28567_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__28567_SHARP_),model_col);
}),sorting)));
}
});
...
var draggable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28570__$1,new cljs.core.Keyword(null,"draggable","draggable",1676206163));
...
return cljs.core.reset_BANG_(data_atom,(function (){var G__28572 = cljs.core.deref(data_atom);
var G__28573 = column_model;
var G__28574 = new cljs.core.Keyword(null,"sorting","sorting",622249690).cljs$core$IFn$_invoke$arity$1(reagent_table.core.update_sort_columns_BANG_(model_col,state_atom,append));
return (sort_fn.cljs$core$IFn$_invoke$arity$3 ? sort_fn.cljs$core$IFn$_invoke$arity$3(G__28572,G__28573,G__28574) : sort_fn.call(null,G__28572,G__28573,G__28574));
})());
} else {
return null;
}
});
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),reagent_table.core.recursive_merge(new cljs.core.Keyword(null,"th","th",-545608566).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"draggable","draggable",1676206163),draggable,new cljs.core.Keyword(null,"on-drag-start","on-drag-start",-47712205),(function (p1__28568_SHARP_){
var G__28575_28615 = p1__28568_SHARP_.dataTransfer;
G__28575_28615.setData("text/plain","");
...
}),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),new cljs.core.Keyword(null,"style","style",-496642736)], null)),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"position","position",-2011731912),"relative",new cljs.core.Keyword(null,"cursor","cursor",1011937484),(cljs.core.truth_(draggable)?"move":null),new cljs.core.Keyword(null,"display","display",242065432),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(col_hidden,model_col))?"none":null)], null),(cljs.core.truth_((function (){var and__4115__auto__ = new cljs.core.Keyword(null,"col-reordering","col-reordering",-165014502).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(and__4115__auto__)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"border-right","border-right",-668932860),"6px solid #3366CC"], null):null)], 0))], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding-right","padding-right",-1250249681),(50)], null)], null),new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(render_info)], null),(cljs.core.truth_((function (){var and__4115__auto__ = sort_fn;
if(cljs.core.truth_(and__4115__auto__)){
return sortable;
} else {
return and__4115__auto__;
}
})())?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"position","position",-2011731912),"absolute",new cljs.core.Keyword(null,"text-align","text-align",1786091845),"center",new cljs.core.Keyword(null,"height","height",1025178622),"1.5em",new cljs.core.Keyword(null,"width","width",-384071477),"1.5em",new cljs.core.Keyword(null,"right","right",-452581833),"15px",new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (p1__28569_SHARP_){
return sort_click_fn(p1__28569_SHARP_.ctrlKey);
})], null),(function (){var pred__28576 = cljs.core._EQ_;
var expr__28577 = reagent_table.core.is_sorting(new cljs.core.Keyword(null,"sorting","sorting",622249690).cljs$core$IFn$_invoke$arity$1(state),render_info,model_col);
if(cljs.core.truth_((pred__28576.cljs$core$IFn$_invoke$arity$2 ? pred__28576.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"asc","asc",356854569),expr__28577) : pred__28576.call(null,new cljs.core.Keyword(null,"asc","asc",356854569),expr__28577)))){
return " \u25B2";
} else {
if(cljs.core.truth_((pred__28576.cljs$core$IFn$_invoke$arity$2 ? pred__28576.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"desc","desc",2093485764),expr__28577) : pred__28576.call(null,new cljs.core.Keyword(null,"desc","desc",2093485764),expr__28577)))){
return " \u25BC";
} else {
if(cljs.core.truth_((pred__28576.cljs$core$IFn$_invoke$arity$2 ? pred__28576.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"none","none",1333468478),expr__28577) : pred__28576.call(null,new cljs.core.Keyword(null,"none","none",1333468478),expr__28577)))){
return null;
} else {
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_table.core.header_cell_fn,render_info,view_col,model_col,config,state_atom,data_atom], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(render_info);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return model_col;
...
var model_col = reagent_table.core.column_index_to_model(state_atom,view_col);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"border-right","border-right",-668932860),(cljs.core.truth_((function (){var and__4115__auto__ = new cljs.core.Keyword(null,"col-reordering","col-reordering",-165014502).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(view_col,new cljs.core.Keyword(null,"col-hover","col-hover",-1561137880).cljs$core$IFn$_invoke$arity$1(state));
} else {
return and__4115__auto__;
}
})())?"2px solid #3366CC":null),new cljs.core.Keyword(null,"display","display",242065432),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(col_hidden,model_col))?"none":null)], null)], null),(function (){var G__28579 = (col_model.cljs$core$IFn$_invoke$arity$1 ? col_model.cljs$core$IFn$_invoke$arity$1(model_col) : col_model.call(null,model_col));
var G__28580 = row;
var G__28581 = row_num;
var G__28582 = model_col;
return (cell_fn.cljs$core$IFn$_invoke$arity$4 ? cell_fn.cljs$core$IFn$_invoke$arity$4(G__28579,G__28580,G__28581,G__28582) : cell_fn.call(null,G__28579,G__28580,G__28581,G__28582));
...
}),(function (){var or__4126__auto__ = col_model;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return row;
...
return null;
})], null),li_config),new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(render_info)," ",(cljs.core.truth_(cljs.core.deref(hidden_a))?"\u2610":"\u2611")], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(render_info);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return model_col;
...
var state_atom = (function (){var or__4126__auto__ = new cljs.core.Keyword(null,"table-state","table-state",-1662785974).cljs$core$IFn$_invoke$arity$1(config__$1);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var map__28583 = config__$1;
var map__28583__$1 = (((((!((map__28583 == null))))?(((((map__28583.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28583.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28583):map__28583);
var render_cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28583__$1,new cljs.core.Keyword(null,"render-cell","render-cell",-515359581));
var column_model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28583__$1,new cljs.core.Keyword(null,"column-model","column-model",1553156630));
if(cljs.core.truth_((function (){var and__4115__auto__ = render_cell;
if(cljs.core.truth_(and__4115__auto__)){
return column_model;
} else {
return and__4115__auto__;
