...
sevenguis.flight_booker.date_format = clojure.string.join.cljs$core$IFn$_invoke$arity$2(sevenguis.flight_booker.date_separator,(function (){var iter__4529__auto__ = (function sevenguis$flight_booker$iter__29668(s__29669){
return (new cljs.core.LazySeq(null,(function (){
var s__29669__$1 = s__29669;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__29669__$1);
if(temp__5735__auto__){
var s__29669__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29669__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__29669__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__29671 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__29670 = (0);
while(true){
if((i__29670 < size__4528__auto__)){
var time_period = cljs.core._nth(c__4527__auto__,i__29670);
cljs.core.chunk_append(b__29671,(time_period.cljs$core$IFn$_invoke$arity$1 ? time_period.cljs$core$IFn$_invoke$arity$1(sevenguis.flight_booker.notation) : time_period.call(null,sevenguis.flight_booker.notation)));

var G__29705 = (i__29670 + (1));
i__29670 = G__29705;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29671),sevenguis$flight_booker$iter__29668(cljs.core.chunk_rest(s__29669__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29671),null);
}
} else {
var time_period = cljs.core.first(s__29669__$2);
return cljs.core.cons((time_period.cljs$core$IFn$_invoke$arity$1 ? time_period.cljs$core$IFn$_invoke$arity$1(sevenguis.flight_booker.notation) : time_period.call(null,sevenguis.flight_booker.notation)),sevenguis$flight_booker$iter__29668(cljs.core.rest(s__29669__$2)));
}
} else {
return null;
}
...
sevenguis.flight_booker.date_pattern = cljs.core.re_pattern(["^",clojure.string.join.cljs$core$IFn$_invoke$arity$2(sevenguis.flight_booker.date_separator,(function (){var iter__4529__auto__ = (function sevenguis$flight_booker$iter__29676(s__29677){
return (new cljs.core.LazySeq(null,(function (){
var s__29677__$1 = s__29677;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__29677__$1);
if(temp__5735__auto__){
var s__29677__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29677__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__29677__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__29679 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__29678 = (0);
while(true){
if((i__29678 < size__4528__auto__)){
var time_period = cljs.core._nth(c__4527__auto__,i__29678);
cljs.core.chunk_append(b__29679,(time_period.cljs$core$IFn$_invoke$arity$1 ? time_period.cljs$core$IFn$_invoke$arity$1(sevenguis.flight_booker.pattern_for) : time_period.call(null,sevenguis.flight_booker.pattern_for)));

var G__29706 = (i__29678 + (1));
i__29678 = G__29706;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29679),sevenguis$flight_booker$iter__29676(cljs.core.chunk_rest(s__29677__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29679),null);
}
} else {
var time_period = cljs.core.first(s__29677__$2);
return cljs.core.cons((time_period.cljs$core$IFn$_invoke$arity$1 ? time_period.cljs$core$IFn$_invoke$arity$1(sevenguis.flight_booker.pattern_for) : time_period.call(null,sevenguis.flight_booker.pattern_for)),sevenguis$flight_booker$iter__29676(cljs.core.rest(s__29677__$2)));
}
} else {
return null;
}
...
sevenguis.flight_booker.actual_date_QMARK_ = (function sevenguis$flight_booker$actual_date_QMARK_(p__29680){
...
var month = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29681__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var day = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29681__$1,new cljs.core.Keyword(null,"day","day",-274800446));
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29681__$1,new cljs.core.Keyword(null,"year","year",335913393));
...
(sevenguis.flight_booker.Date.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29684,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29684,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__29689){
var vec__29690 = p__29689;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29690,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29690,(1),null);
...
(sevenguis.flight_booker.Date.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29685,other29686){
var self__ = this;
var this29685__$1 = this;
return (((!((other29686 == null)))) && ((this29685__$1.constructor === other29686.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29685__$1.month,other29686.month)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29685__$1.day,other29686.day)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29685__$1.year,other29686.year)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29685__$1.__extmap,other29686.__extmap)));
}));
...
(sevenguis.flight_booker.Date.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29683){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__29693 = cljs.core.keyword_identical_QMARK_;
var expr__29694 = k__4388__auto__;
if(cljs.core.truth_((pred__29693.cljs$core$IFn$_invoke$arity$2 ? pred__29693.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"month","month",-1960248533),expr__29694) : pred__29693.call(null,new cljs.core.Keyword(null,"month","month",-1960248533),expr__29694)))){
return (new sevenguis.flight_booker.Date(G__29683,self__.day,self__.year,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29693.cljs$core$IFn$_invoke$arity$2 ? pred__29693.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"day","day",-274800446),expr__29694) : pred__29693.call(null,new cljs.core.Keyword(null,"day","day",-274800446),expr__29694)))){
return (new sevenguis.flight_booker.Date(self__.month,G__29683,self__.year,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29693.cljs$core$IFn$_invoke$arity$2 ? pred__29693.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"year","year",335913393),expr__29694) : pred__29693.call(null,new cljs.core.Keyword(null,"year","year",335913393),expr__29694)))){
return (new sevenguis.flight_booker.Date(self__.month,self__.day,G__29683,self__.__meta,self__.__extmap,null));
} else {
return (new sevenguis.flight_booker.Date(self__.month,self__.day,self__.year,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29683),null));
}
}
}
}));
...
(sevenguis.flight_booker.Date.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29683){
var self__ = this;
var this__4379__auto____$1 = this;
return (new sevenguis.flight_booker.Date(self__.month,self__.day,self__.year,G__29683,self__.__extmap,self__.__hash));
}));
 ...
 */
sevenguis.flight_booker.map__GT_Date = (function sevenguis$flight_booker$map__GT_Date(G__29687){
var extmap__4419__auto__ = (function (){var G__29696 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29687,new cljs.core.Keyword(null,"month","month",-1960248533),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"day","day",-274800446),new cljs.core.Keyword(null,"year","year",335913393)], 0));
...
return (new sevenguis.flight_booker.Date(new cljs.core.Keyword(null,"month","month",-1960248533).cljs$core$IFn$_invoke$arity$1(G__29687),new cljs.core.Keyword(null,"day","day",-274800446).cljs$core$IFn$_invoke$arity$1(G__29687),new cljs.core.Keyword(null,"year","year",335913393).cljs$core$IFn$_invoke$arity$1(G__29687),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var v = s;
var v__$1 = cljs.core.fnil.cljs$core$IFn$_invoke$arity$2((function (p1__29697_SHARP_){
return cljs.core.re_matches(sevenguis.flight_booker.date_pattern,p1__29697_SHARP_);
}),"")(v);
return (!((v__$1 == null)));
});
...
sevenguis.flight_booker.modal = (function sevenguis$flight_booker$modal(p__29698){
...
var _BANG_modal_element = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29699__$1,new cljs.core.Keyword(null,"!modal-element","!modal-element",-800405911));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29699__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var button_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29699__$1,new cljs.core.Keyword(null,"button-text","button-text",-1800441720));
var times_symbol = "\u00D7";
...
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.gui.flight-booker","div.gui.flight-booker",-1900412236),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select","select",1147833503),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__29701_SHARP_){
return cljs.core.reset_BANG_(sevenguis.flight_booker._BANG_flight_type,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__29701_SHARP_.target.value));
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"one-way","one-way",-1465093708)], null),"One-way flight"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"round-trip","round-trip",99316507)], null),"Round-trip flight"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(sevenguis.flight_booker._BANG_departure_input),new cljs.core.Keyword(null,"className","className",-1983287057),((sevenguis.flight_booker.bad_input_QMARK_(cljs.core.deref(sevenguis.flight_booker._BANG_departure_input)))?"bad-input":null),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),sevenguis.flight_booker.date_format,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__29702_SHARP_){
return cljs.core.reset_BANG_(sevenguis.flight_booker._BANG_departure_input,p1__29702_SHARP_.target.value);
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),(cljs.core.truth_(cljs.core.deref(sevenguis.flight_booker._BANG_one_way_QMARK_))?null:cljs.core.deref(sevenguis.flight_booker._BANG_return_input)),new cljs.core.Keyword(null,"className","className",-1983287057),((((cljs.core.not(cljs.core.deref(sevenguis.flight_booker._BANG_one_way_QMARK_))) && (sevenguis.flight_booker.bad_input_QMARK_(cljs.core.deref(sevenguis.flight_booker._BANG_return_input)))))?"bad-input":null),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),(cljs.core.truth_(cljs.core.deref(sevenguis.flight_booker._BANG_one_way_QMARK_))?null:sevenguis.flight_booker.date_format),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__29703_SHARP_){
return cljs.core.reset_BANG_(sevenguis.flight_booker._BANG_return_input,p1__29703_SHARP_.target.value);
...
}),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(sevenguis.flight_booker._BANG_success_state),new cljs.core.Keyword(null,"not-ready","not-ready",-191902149))], null),"Book!"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sevenguis.flight_booker.modal,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"!modal-element","!modal-element",-800405911),sevenguis.flight_booker._BANG_modal,new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var fexpr__29704 = cljs.core.deref(sevenguis.flight_booker._BANG_success_state);
return (fexpr__29704.cljs$core$IFn$_invoke$arity$1 ? fexpr__29704.cljs$core$IFn$_invoke$arity$1(sevenguis.flight_booker.message) : fexpr__29704.call(null,sevenguis.flight_booker.message));
})()], null)], null)], null);
});
