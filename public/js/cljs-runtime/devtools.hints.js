...
var temp__5733__auto___28710 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___28710)){
var seen_errors_28711 = temp__5733__auto___28710;
if(cljs.core.truth_(seen_errors_28711.has(self))){
} else {
seen_errors_28711.add(self);

var temp__5735__auto___28712 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___28712)){
var sense_28713 = temp__5735__auto___28712;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28713)].join(''));
} else {
}
}
} else {
