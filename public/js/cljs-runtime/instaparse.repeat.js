...
var vec__29749 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29749,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29749,(1),null);
...
var vec__29752 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__29779 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29779,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29779,(1),null);
...
var G__30049 = cljs.core.next(parses__$1);
parses__$1 = G__30049;
continue;
}
...
var G__29806 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__29807 = G__29806;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29807,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29807,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29807,(2),null);
var selection = vec__29807;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__29806__$1 = G__29806;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__29825 = G__29806__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29825,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29825,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29825,(2),null);
var selection__$1 = vec__29825;
...
var G__30053 = cljs.core.long$(end__$1);
var G__30054 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__30055 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__30053;
parses__$1 = G__30054;
G__29806__$1 = G__30055;
continue;
...
var G__29858 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__29861 = G__29858;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29861,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29861,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29861,(2),null);
var selection = vec__29861;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__29858__$1 = G__29858;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__29876 = G__29858__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29876,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29876,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29876,(2),null);
var selection__$1 = vec__29876;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__30063 = cljs.core.long$(end__$1);
var G__30064 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__30065 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__30063;
parses__$1 = G__30064;
G__29858__$1 = G__30065;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__29895 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__29896 = G__29895;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29896,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29896,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29896,(2),null);
var selection = vec__29896;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__29906 = G__29895__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29906,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29906,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29906,(2),null);
var selection__$1 = vec__29906;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__30067 = cljs.core.long$(end__$1);
var G__30068 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__30069 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__30067;
parses__$1 = G__30068;
G__29895__$1 = G__30069;
continue;
...
if(cljs.core.truth_((function (){var fexpr__29927 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__29927.cljs$core$IFn$_invoke$arity$1 ? fexpr__29927.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__29927.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__29967 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__29966 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
