...
var G__40279 = o;
goog.object.set(G__40279,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__40308__i < G__40308__a.length) {G__40308__a[G__40308__i] = arguments[G__40308__i + 0]; ++G__40308__i;}
  args = new cljs.core.IndexedSeq(G__40308__a,0,null);
} 
return G__40306__delegate.call(this,args);};
G__40306.cljs$lang$maxFixedArity = 0;
G__40306.cljs$lang$applyTo = (function (arglist__40309){
...
var G__40280 = o;
goog.object.set(G__40280,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__40321__i < G__40321__a.length) {G__40321__a[G__40321__i] = arguments[G__40321__i + 0]; ++G__40321__i;}
  args = new cljs.core.IndexedSeq(G__40321__a,0,null);
} 
return G__40315__delegate.call(this,args);};
G__40315.cljs$lang$maxFixedArity = 0;
G__40315.cljs$lang$applyTo = (function (arglist__40322){
var args = cljs.core.seq(arglist__40322);
...
var G__40281 = props;
var G__40281__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40281,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40281);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40281__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__40282 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40282,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__40282;
}
})(),id_class);
...
var G__40283 = (cljs.core.count(argv) - first_child);
switch (G__40283) {
case (0):
...
var vec__40284 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40284,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40284,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40284,(2),null);
...
var temp__5739__auto___40330 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___40330 == null)){
} else {
var key_40331 = temp__5739__auto___40330;
(jsprops.key = key_40331);
}
...
var temp__5739__auto___40332 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___40332 == null)){
} else {
var key_40333 = temp__5739__auto___40332;
(jsprops.key = key_40333);
}
...
var temp__5739__auto___40336 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___40336 == null)){
} else {
var key_40337 = temp__5739__auto___40336;
(jsprops.key = key_40337);
}
...
var temp__5739__auto___40341 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___40341 == null)){
} else {
var key_40342 = temp__5739__auto___40341;
(jsprops.key = key_40342);
}
...
var temp__5739__auto___40344 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___40344 == null)){
} else {
var key_40345 = temp__5739__auto___40344;
(jsprops.key = key_40345);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40292_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__40292_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__40293 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40293,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40293,(1),null);
...
break;
default:
var G__40347 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__40348 = compiler;
v = G__40347;
compiler = G__40348;
continue;
...
var G__40297 = tag;
var G__40297__$1 = (((G__40297 instanceof cljs.core.Keyword))?G__40297.fqn:null);
switch (G__40297__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template40299 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template40299 = (function (opts,id,fn_to_element,meta40300){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template40299.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40301,meta40300__$1){
var self__ = this;
var _40301__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template40299(self__.opts,self__.id,self__.fn_to_element,meta40300__$1));
}));

(reagent.impl.template.t_reagent$impl$template40299.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40301){
var self__ = this;
var _40301__$1 = this;
return self__.meta40300;
}));

(reagent.impl.template.t_reagent$impl$template40299.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template40299.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template40299.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template40299.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template40299.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta40300","meta40300",690764964,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template40299.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template40299.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template40299");

(reagent.impl.template.t_reagent$impl$template40299.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template40299");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template40299.
 */
reagent.impl.template.__GT_t_reagent$impl$template40299 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template40299(opts__$1,id__$1,fn_to_element__$1,meta40300){
return (new reagent.impl.template.t_reagent$impl$template40299(opts__$1,id__$1,fn_to_element__$1,meta40300));
});

}

return (new reagent.impl.template.t_reagent$impl$template40299(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
