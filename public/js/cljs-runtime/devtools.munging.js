...
var o30610 = temp__5733__auto__;
var temp__5733__auto____$1 = (o30610["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o30611 = temp__5733__auto____$1;
return (o30611["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28590__auto__ = f;
return (o__28590__auto__["toString"]).call(o__28590__auto__);
} else {
return "";
}
}catch (e30614){var _ = e30614;
return "";
}});
...
try{var o__28590__auto___30816 = t;
(o__28590__auto___30816["cljs$lang$ctorPrWriter"]).call(o__28590__auto___30816,t,writer);
}catch (e30615){var __30817 = e30615;
}
...
var char_code = (function (){var o__28590__auto__ = (new String(char$));
return (o__28590__auto__["charCodeAt"]).call(o__28590__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28590__auto__ = String;
return (o__28590__auto__["fromCharCode"]).call(o__28590__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30618 = num_code;
switch (G__30618) {
case (1):
return (185);
...
var o__28590__auto__ = String;
return (o__28590__auto__["fromCharCode"]).call(o__28590__auto__,superscript_code);
});
/**
...
}catch (e30620){var _e__28605__auto__ = e30620;
return false;
}})())){
...
var vec__30621 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30621,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30634){
var vec__30635 = p__30634;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30635,(0),null);
...
var G__30841 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30842 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30841;
remaining_tokens = G__30842;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30630){
...
var vec__30641 = cljs.core.split_with((function (p1__30640_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30640_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30641,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30641,(1),null);
...
var vec__30648 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30648,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30648,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30856 = cljs.core.rest(remaining_tokens);
var G__30857 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30856;
name_tokens = G__30857;
continue;
} else {
...
var vec__30653 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30653,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30653,(1),null);
var vec__30656 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30656,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30656,(1),null);
var vec__30659 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30659,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30659,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30659,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30659,(3),null);
...
var vec__30664 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(4),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__30667 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30667,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30667,(1),null);
var vec__30670 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30670,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30670,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30674 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30674) : devtools.munging.parse_fn_info_deep.call(null,G__30674));
})()));
}
} else {
return fn_info;
...
var G__30868 = (arity + (1));
var G__30869 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30691){
var vec__30693 = p__30691;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30693,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30693,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30710_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30710_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30711_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30711_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___30879 = arguments.length;
var i__4737__auto___30880 = (0);
while(true){
if((i__4737__auto___30880 < len__4736__auto___30879)){
args__4742__auto__.push((arguments[i__4737__auto___30880]));

var G__30881 = (i__4737__auto___30880 + (1));
i__4737__auto___30880 = G__30881;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30719){
var vec__30720 = p__30719;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30720,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30717){
var G__30718 = cljs.core.first(seq30717);
var seq30717__$1 = cljs.core.next(seq30717);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30718,seq30717__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30728__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30728__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30728__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30728__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30729 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30729,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30729,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30729,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30729,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30729,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30729,(5),null);
...
var o__28590__auto__ = f;
return (o__28590__auto__["getBasis"]).call(o__28590__auto__);
});
/**
...
}catch (e30736){var _e__28605__auto__ = e30736;
...
var G__30883 = (obj[cljs.core.first(path)]);
var G__30884 = cljs.core.rest(path);
obj = G__30883;
path = G__30884;
continue;
} else {
...
var _STAR_ = (function (accum,p__30777){
var vec__30778 = p__30777;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30778,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30778,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30783){
var vec__30784 = p__30783;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30784,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30784,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30784,(2),null);
...
var post_process = (function (p__30811){
var vec__30812 = p__30811;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30812,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30812,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30794_SHARP_){
return (obj[cljs.core.first(p1__30794_SHARP_)]);
}),sorted_matches);
